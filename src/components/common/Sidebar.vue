                ...
                <template v-if="item.subs">
                    <el-submenu :index="item.index" :key="item.index">
                        ...
                        <template v-for="subItem in item.subs">
                            ...
                            <el-menu-item v-else :index="subItem.index" :key="subItem.index" class="textColor">
                                <router-link :to="{path:subItem.path}" style="color:rgb(191, 203, 217)"><div style="width">{{ subItem.title }}</div></router-link>
                            </el-menu-item>
                        </template>
                    </el-submenu>
                </template>
